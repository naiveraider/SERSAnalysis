...
echo "=========================================="
echo "Training Task 4 - All Models"
echo "=========================================="
echo ""
...
{
  echo "Task 4 - Test Metrics Summary"
  echo "Generated: $(date)"
  echo "N_RUNS=$N_RUNS"
  echo ""
} > "$RESULTS_FILE"
...
echo ""
echo "=========================================="
echo "Training LSTM Model for Task 4 ($N_RUNS runs, result averaged)"
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "LSTM" python script/train_task4.py \
...
echo ""
echo "=========================================="
echo "Training GRU Model for Task 4 ($N_RUNS runs, result averaged)"
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "GRU" python script/train_task4.py \
    --model gru --epochs $EPOCHS --batch_size $BATCH_SIZE --learning_rate $LEARNING_RATE \
    --validation_split $VALIDATION_SPLIT --lstm_hidden_size 128 --lstm_num_layers 2 --lstm_dropout 0.2

echo ""
echo "=========================================="
echo "Training InceptionTime Model for Task 4 ($N_RUNS runs, result averaged)"
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "InceptionTime" python script/train_task4.py \
...
echo ""
echo "=========================================="
echo "Training MiniROCKET Model for Task 4 ($N_RUNS runs, result averaged)"
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "MiniROCKET" python script/train_task4.py \
