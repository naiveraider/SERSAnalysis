...
Models are saved to:
- Task 1: `model/task1_cnn/` or `model/task1_tcn/`
- Task 2: `model/task2_cnn/` or `model/task2_tcn/`
- Task 3: `model/task3_cnn/` or `model/task3_tcn/`
- Task 4: `model/task4_cnn/` or `model/task4_tcn/`
