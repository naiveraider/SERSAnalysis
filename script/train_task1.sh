...
# Results summary file for this task (each model's per-run metrics + averages)
mkdir -p results
RESULTS_FILE="results/task1_summary.txt"
{
  echo "Task 1 - Test Metrics Summary"
  echo "Generated: $(date)"
  echo "N_RUNS=$N_RUNS"
  echo ""
} > "$RESULTS_FILE"
...
# Average numeric metric values, skipping NaN runs.
compute_average() {
  local precision="$1"
  shift
  python - <<'PY' "$precision" "$@"
...
# Run a command N_RUNS times, collect final metrics from each run, print averages, append to results file.
# Usage: run_n_times_and_average <results_file> <model_label> <cmd...>
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "CNN" python script/train_task1.py \
    --model cnn \
    --epochs $EPOCHS \
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "TCN" python script/train_task1.py \
    --model tcn \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "CNN+Transformer" python script/train_task1.py \
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "Mamba/S4" python script/train_task1.py \
    --model mamba \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "ViT" python script/train_task1.py \
    --model vit \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "Static Hybrid" python script/train_task1.py \
    --model static_hybrid \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo ""
echo "=========================================="
echo "Training LSTM Model for Task 1 ($N_RUNS runs, result averaged)"
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "LSTM" python script/train_task1.py \
    --model lstm \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo ""
echo "=========================================="
echo "Training GRU Model for Task 1 ($N_RUNS runs, result averaged)"
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "GRU" python script/train_task1.py \
    --model gru \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo ""
echo "=========================================="
echo "Training InceptionTime Model for Task 1 ($N_RUNS runs, result averaged)"
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "InceptionTime" python script/train_task1.py \
    --model inceptiontime \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo ""
echo "=========================================="
echo "Training MiniROCKET Model for Task 1 ($N_RUNS runs, result averaged)"
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "MiniROCKET" python script/train_task1.py \
    --model minirocket \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
    --validation_split $VALIDATION_SPLIT \
    --minirocket_num_kernels 1000 \
    --minirocket_seed 42 \
    --minirocket_dropout 0.2
