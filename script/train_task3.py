...
def main():
    ...
    # Get all folders in datasets/3/
    from pathlib import Path
    data_dir = Path("datasets") / "3"
    
    if not data_dir.exists():
        raise ValueError(f"Task 3 directory not found: {data_dir}")
    ...
    for folder in folders:
        ...
        train_model(
            ...
            model_save_path=f"models/3/{args.model}/{folder_name}",
