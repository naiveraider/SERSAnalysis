...
mkdir -p results
RESULTS_FILE="results/task3_summary.txt"
{
  echo "Task 3 - Test Accuracy Summary"
  echo "Generated: $(date)"
  echo "N_RUNS=$N_RUNS"
  echo ""
} > "$RESULTS_FILE"
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "CNN" python script/train_task3.py \
    --model cnn \
    --epochs $EPOCHS \
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "TCN" python script/train_task3.py \
    --model tcn \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "CNN+Transformer" python script/train_task3.py \
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "Mamba/S4" python script/train_task3.py \
    --model mamba \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "ViT" python script/train_task3.py \
    --model vit \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo "=========================================="
run_n_times_and_average "$RESULTS_FILE" "Static Hybrid" python script/train_task3.py \
    --model static_hybrid \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
