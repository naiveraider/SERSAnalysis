...
echo "=========================================="
run_n_times_and_average "CNN" python script/train_task2.py \
    --model cnn \
    --epochs $EPOCHS \
...
echo "=========================================="
run_n_times_and_average "TCN" python script/train_task2.py \
    --model tcn \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo "=========================================="
run_n_times_and_average "CNN+Transformer" python script/train_task2.py \
...
echo "=========================================="
run_n_times_and_average "Mamba/S4" python script/train_task2.py \
    --model mamba \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo "=========================================="
run_n_times_and_average "ViT" python script/train_task2.py \
    --model vit \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
...
echo "=========================================="
run_n_times_and_average "Static Hybrid" python script/train_task2.py \
    --model static_hybrid \
    --epochs $EPOCHS \
    --batch_size $BATCH_SIZE \
    --learning_rate $LEARNING_RATE \
