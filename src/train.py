...
def train_model(
    ...
    **model_kwargs
    ...
    print(f"accuracy_score: {final_metrics['accuracy']:.2f}%")
    print(f"f1_score: {final_metrics['f1']:.4f}")
    print(f"jaccard_score: {final_metrics['jaccard']:.4f}")
    print(f"average_precision_score: {final_metrics['auprc']:.4f}")
    print(f"roc_auc_score: {final_metrics['auroc']:.4f}")
...
def main():
    ...
    elif args.model in ['lstm', 'stacked_lstm', 'bilstm', 'lstm_attention', 'lstm_cnn', 'cnn_lstm', 'cnn_bilstm_attention', 'gru', 'bigru', 'bigru_meanmax', 'layernorm_bigru']:
        model_kwargs = {
